...
import com.gamexo.backend.config.security.userdetails.UserDetailsServiceImpl;
...
public class AuthController {
    ...
    @Operation(
        ...
        No JWT token is required to access this endpoint. Only users with the role CLIENT can be registered.
        """,
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    ...
                    content = @Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = UserAuthorizedDTO.class),
                            examples = @ExampleObject(
